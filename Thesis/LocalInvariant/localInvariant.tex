...
\begin{figure}[!htbp]
  	\begin{center}
   	\includegraphics[width=0.7\textwidth]{SquareRotate}
	\end{center}
...
\begin{figure}[!htbp]
  \begin{center}
      \includegraphics[width=0.7\textwidth]{OffsetAction}
...
\begin{figure}[!htbp]
  \begin{center}
      \includegraphics[width=0.7\textwidth]{EnergyScaling}
...
\begin{figure}
  \begin{center}
      \includegraphics[width=0.7\textwidth]{TimeOffset}
    \caption{Offset Action}
    \label{fig:gtoff}
\end{center}
\end{figure}
