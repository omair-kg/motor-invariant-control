...
\nomenclature[f3]{$\mathcal{I}(x)$}{Invariant Function of $x$}
...
To check such properties with the shape example, $g_1$ is  $90$ degree clockwise rotation. then $e$ is no rotation.
