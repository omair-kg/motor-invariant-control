...
\nomenclature[b1]{$Q$}{Configureation Space or Configuration Manifold}
\nomenclature[b2]{$TQ$}{Tangenet Bundle of $Q$}
\nomenclature[b3]{$M$}{State Space Manifold}
\nomenclature[b4]{$TM$}{Tangent Boundle Manifold}



\nomenclature[c1]{$A$}{Attractor}
\nomenclature[c2]{$B(A)$}{Basin of Attration of $A$}
\nomenclature[c3]{$\simeq$}{Topology Conjungacy}



\nomenclature[d1]{$S$}{Neural Oscilator}
\nomenclature[d2]{$\uin$}{Input Signal to the Neural Oscilator}
\nomenclature[d3]{$\uout$}{Output of the Neural Oscilator}
\nomenclature[d4]{$\hin$}{Input Coefficient of the Neural Oscilator}
\nomenclature[d5]{$\hout$}{Output Coefficent of the Neural Oscilator}
