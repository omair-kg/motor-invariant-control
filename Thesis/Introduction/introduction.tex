...
\begin{figure}[!htbp]
  \begin{center}
    \includegraphics[width=0.5\textwidth]{ShipExample}
...
\begin{figure}[h]
\begin{center}
	\subfigure[The Stable Equilibrium Posture]
	{
	\includegraphics[width=0.45\textwidth]{leftPos}
	\label{fig:ShipEqulibriumStable}
	}
	\subfigure[The Unstable Equilibrium Posture]
	{
	\includegraphics[width=0.45\textwidth]{rightPos}
...
\begin{center}
	\subfigure[The Stable Equilibrium Posture]
	{
	\includegraphics[width=0.45\textwidth]{stablePosition}
	\label{fig:StablePosture}
	}
	\subfigure[The Unstable Equilibrium Posture]
	{
	\includegraphics[width=0.45\textwidth]{unstablePosition}
...
\begin{figure}[!htbp]
  \begin{center}
   \includegraphics[width=0.5\textwidth]{ShipGlobalFlow}
...
\begin{figure}[!htbp]
  \begin{center}
   \includegraphics[width=0.5\textwidth]{topologyStructure}
...
\begin{figure}[!htbp]
  \begin{center}
    \includegraphics[width=0.5\textwidth]{MassSpring}
