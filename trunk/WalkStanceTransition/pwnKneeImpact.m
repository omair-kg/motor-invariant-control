...
Q23m(1,1)=-(ms*lt+mt*b2)*l*cal-ms*b1*cbe+(mt+ms+MHStance)*l*l+MSStance*a1*a1+MTStance*(ls+a2)*(ls+a2);
...
Q22p(1,1)=Q22p(2,1)+MTStance*(ls+a2)*(ls+a2)+(MHStance+mt+ms)*l*l+MSStance*a1*a1;
