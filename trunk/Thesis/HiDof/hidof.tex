...
according the mechanical structure, this is equivalent to simulte two part of the mechanical structure independently and perturbation are as coupling effects.
\begin{figure}[!htbp]
  \begin{center}
