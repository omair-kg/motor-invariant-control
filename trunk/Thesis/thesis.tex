...
% insert below the file name that contains the crest in-place of 'UnivShield'
  \crest{\includegraphics[width=30mm]{bu_logo}}

%
% insert below the file name that contains the crest in-place of 'UnivShield'
% \crest{\IncludeGraphicsW{}{40mm}{14 14 73 81}}
%
...
\newcommand{\moit}{\textbf{MoIT}}
\newcommand{\BOA}[1]{\mathcal{Boa}(#1)}
\newcommand{\boa}{\textbf{BoA}}
\begin{document}
...
\include{GlobalInvariant/gInvariant}
\include{LocalInvariant/localInvariant}
\include{CombineFramework/cframework}
\include{BipedWalk/bwalk}
\include{WalkStance/stance}
\include{HiDof/hidof}
