...
global SOUT;
	...
	GSlopeAction(1,1)=-(ms*a1+mt*(ls+a2)+(mh+ms+mt)*l)*g*sin(q1-SlopeAction)*sa;
	...
	U3=[1,-1,0]'*SOUT;
	ddqp= H3\(-B3*qd-(uSlopeAction+uSpeedAction+G3)+U3);
